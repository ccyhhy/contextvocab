...
function getMetricConfig(result: StudySubmissionResult) {
...
function EvaluationDetails({
  ...
  result: StudySubmissionResult
  sentence: string
  onPlayAudio: (text: string) => void
}) {
  const metricConfig = getMetricConfig(result)

  return (
    <div className="space-y-4">
      <div className="space-y-2.5">
        <SubScoreBar
          label={metricConfig.first.label}
          score={metricConfig.first.score}
          color={metricConfig.first.color}
        />
        <SubScoreBar
          label={metricConfig.second.label}
          score={metricConfig.second.score}
          color={metricConfig.second.color}
        />
        <SubScoreBar
          label={metricConfig.third.label}
          score={metricConfig.third.score}
          color={metricConfig.third.color}
        />
      </div>

      {result.targetKind === "grammar" ? (
