...
export function StudyGrammarPanel({
  ...
  return (
    ...
    >
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-5 text-zinc-300 sm:p-6">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm leading-7 text-zinc-200 sm:text-[15px]">{grammar.coreExplanation}</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {(grammar.usageNote || grammar.sceneTags.length > 0 || usageRegisterLabel) && (
          <div className="rounded-2xl border border-white/[0.08] bg-black/20 p-5 xl:col-span-1">
        ...
        {grammar.slotSchema.length > 0 && (
          <div className="rounded-2xl border border-white/[0.08] bg-black/20 p-5 md:col-span-2 xl:col-span-2">
        ...
        {grammar.templates.length > 0 && (
          <div className="rounded-2xl border border-white/[0.08] bg-black/20 p-5 md:col-span-2 xl:col-span-3">
            ...
            <div className="mt-3 grid gap-3 xl:grid-cols-2">
              {grammar.contrasts.map((contrast) => (
                <div
                  ...
                  className="rounded-xl border border-white/10 bg-white/[0.03] px-4 py-4 text-sm leading-7 text-zinc-300"
                >
