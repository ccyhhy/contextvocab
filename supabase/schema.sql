...
-- 1.4 grammar / pattern study items
...
CREATE TABLE IF NOT EXISTS public.libraries (
    ...
    content_type TEXT NOT NULL DEFAULT 'word' CHECK (content_type IN ('word', 'grammar', 'mixed')),
